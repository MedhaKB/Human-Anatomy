...
void drawRibs()
{
    ...
    drawstring1(-20,-30,0,"RIBCAGE OF SKELETON");
    glLineWidth(15);
...
glLineWidth(15);
GLfloat i;
glColor3ub(240,150,50);//large intestine
glBegin(GL_LINE_LOOP);
glVertex3f(-1,-17.5,0);
glVertex3f(-1,-15,0);
glVertex3f(4,-15,0);
...
strflag=0;
glColor3f(0,0,0);
drawstring1(-17,1,0.0,"The alveoli don't just pass oxygen to our blood,they also help to clean out ");
...
glutAddMenuEntry("Rib cage",5);
glutAddMenuEntry("Description",4);
